...
export class MensajesService {
  ...
  public nuevoMensaje( mensaje: Mensaje){
    ...
    return this.itemsCollection.add( {mensaje:mensaje.mensaje, fecha:mensaje.fecha, usuario:mensaje.usuario, nombreUsuario:mensaje.nombreUsuario, timestamp:mensaje.timestamp, grupo:mensaje.grupo} );
  }
