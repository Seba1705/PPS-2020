...
let NewPostPage = class NewPostPage {
    constructor(database, router, loadingCtrl, route, navCtrl) {
        ...
        this.loadingCtrl
            ...
            uploadTask.task.on('state_changed', (snapshot) => {
                ...
                uploadTask.task.snapshot.ref.getDownloadURL().then((downloadURL) => {
                    ...
                    _capacitor_core__WEBPACK_IMPORTED_MODULE_7__["Plugins"].Storage.get({ key: 'user-bd' }).then((userData) => {
                        this.database.AgregarUno(JSON.parse(JSON.stringify(new src_app_models_post__WEBPACK_IMPORTED_MODULE_6__["Post"]({
                            date: new Date(),
...
//# sourceMappingURL=gallery-list-new-post-new-post-module-es2015.js.map