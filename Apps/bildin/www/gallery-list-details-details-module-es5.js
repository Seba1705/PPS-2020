...
var DetailsPage = /** @class */ (function () {
    function DetailsPage(route, navCtrl, database, toastController) {
        this.route = route;
    ...
    DetailsPage.prototype.ngOnInit = function () {
        ...
        _capacitor_core__WEBPACK_IMPORTED_MODULE_5__["Plugins"].Storage.get({ key: 'user-bd' }).then(function (userData) {
        ...
        this.route.paramMap.subscribe(function (paramMap) {
            ...
            _this.database.TraerUno('picbild-posts', _this.postId).then(function (post) {
                // console.log('este es el post ' + JSON.stringify(post));
                _this.post = post;
                _this.voted = (_this.post.votes || _this.post.votes.length < 1) ? _this.post.votes.includes(_this.user.id) : false;
                _this.isLoading = false;
                setTimeout(function () { return _this.spinner = false; }, 1000);
            });
        });
    };
    DetailsPage.prototype.onVote = function () {
        var _this = this;
        if (!this.post.votes) {
            this.post.votes = [];
        }
    ...
    DetailsPage.prototype.onCancelVote = function () {
        var _this = this;
        var index = this.post.votes.indexOf(this.user.id);
        if (index > -1) {
    ...
    DetailsPage.prototype.presentToast = function () {
...
//# sourceMappingURL=gallery-list-details-details-module-es5.js.map