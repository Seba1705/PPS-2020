...
let ListPage = class ListPage {
    constructor(database, auth, navCtrl, route, alertController, toastController) {
    ...
    ngOnInit() {
        ...
        _capacitor_core__WEBPACK_IMPORTED_MODULE_6__["Plugins"].Storage.get({ key: 'user-bd' }).then((userData) => {
...
//# sourceMappingURL=gallery-list-list-module-es2015.js.map