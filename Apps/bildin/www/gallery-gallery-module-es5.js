...
var GalleryPage = /** @class */ (function () {
    function GalleryPage(navCtrl, authService, alertController) {
    ...
    GalleryPage.prototype.ngOnInit = function () {
        ...
        _capacitor_core__WEBPACK_IMPORTED_MODULE_4__["Plugins"].Storage.get({ key: 'user-bd' }).then(function (userData) {
            _this.user = JSON.parse(userData.value);
        }, function () {
            _this.navCtrl.navigateBack('login');
        });
    };
    GalleryPage.prototype.logout = function () {
        var _this = this;
    ...
    GalleryPage.prototype.presentAlertLogout = function () {
